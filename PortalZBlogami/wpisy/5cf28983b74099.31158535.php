<!doctype html>
			<html lang='pl'>
			  ...
			  <body class='testowy_body'>
				<header class='wpis-header'>
					<div class='tytul-wpisu'>
						<h1>Herbata ekspresowa a herbata liściasta – porównanie </h1>
					</div>
				</header>
				
				<main>
					<div class='container wpis'>
						<div class='info_wpisu py-3'>
							<div class='autor'>
								<h4>Maciej Stafiej</h4>
							</div>
